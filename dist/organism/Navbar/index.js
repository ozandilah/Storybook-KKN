...
function Navbar({ children, cta, pathname, className, image, title }) {
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("header", { className: "sticky top-0 z-50", children: (0, jsx_runtime_1.jsx)("nav", { className: "bg-white backdrop-filter backdrop-blur-lg bg-opacity-30", children: (0, jsx_runtime_1.jsxs)("div", { className: "px-6 container mx-auto flex justify-between items-center py-8", children: [(0, jsx_runtime_1.jsx)(Brand_1.default, { className: "w-16 h-10 mr-12 flex items-center" }), (0, jsx_runtime_1.jsxs)("button", { className: "relative z-30 w-7 h-7 flex lg:hidden flex-col items-center justify-center transition-all gap-y-1 hover:gap-y-2", onClick: () => setMenuActive((prev) => !prev), children: [(0, jsx_runtime_1.jsx)("span", { className: [
